package com.zjwz.cmm.mydemo.zxing.activity;
...
import com.zjwz.cmm.mydemo.zxing.camera.CameraManager;
import com.zjwz.cmm.mydemo.zxing.decoding.CaptureActivityHandler;
import com.zjwz.cmm.mydemo.zxing.decoding.InactivityTimer;
import com.zjwz.cmm.mydemo.zxing.decoding.RGBLuminanceSource;
import com.zjwz.cmm.mydemo.zxing.view.ViewfinderView;
...
/**
 * Initial the camera
 * 暴露出来进行调用的界面，在handleDecode方法中对扫码成功后的动作进行处理。
 * @author Ryan.Tang
 */
